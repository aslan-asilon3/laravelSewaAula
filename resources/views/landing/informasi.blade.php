...
<div class="tm-section tm-bg-img" id="tm-section-1" style="width: ";>
    <div class="tm-bg-white ie-container-width-fix-2" style="width: ; ";>
        <div class="container ie-h-align-center-fix" style="width: ";>
            <div class="row">
                <div class="col-xs-12 ml-auto mr-auto ie-container-width-fix" style="margin-bottom:50px;">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                    <div class="tm-article-carousel">                            
                                        <article class="tm-bg-white mr-2 tm-carousel-item">
                                            <img src="{{ asset('assets-landing/img/img-01.jpg')}}" alt="Image" class="img-fluid">
                                        ...
                                        <article class="tm-bg-white mr-2 tm-carousel-item">
                                            <img src="{{ asset('assets-landing/img/img-02.jpg')}}" alt="Image" class="img-fluid">
                                            <div class="tm-article-pad">
                                        ...
                                        <article class="tm-bg-white mr-2 tm-carousel-item">
                                            <img src="assets-landing/img/img-02.jpg" alt="Image" class="img-fluid">
                                            <div class="tm-article-pad">
                                        ...
                                        <article class="tm-bg-white mr-2 tm-carousel-item">
                                            <img src="assets-landing/img/img-01.jpg" alt="Image" class="img-fluid">
                                            <div class="tm-article-pad">
